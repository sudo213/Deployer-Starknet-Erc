...
async def deploy_erc20_contract():
    ...
    erc20_contract = await Contract.deploy(client=client, compilation_source=ERC20_FILE, constructor_args=constructor_args)
...
if __name__ == '__main__':
    ...
    loop.run_until_complete(deploy_erc20_contract())
